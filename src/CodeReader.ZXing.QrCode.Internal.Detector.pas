...
unit CodeReader.ZXing.QrCode.Internal.Detector;
...
uses
  ...
  CodeReader.ZXing.Common.PerspectiveTransform,
  CodeReader.ZXing.QrCode.Internal.FinderPatternInfo,
  CodeReader.ZXing.QrCode.Internal.FinderPatternFinder,
  CodeReader.ZXing.QrCode.Internal.FinderPattern,
  CodeReader.ZXing.QrCode.Internal.AlignmentPattern,
  CodeReader.ZXing.QrCode.Internal.AlignmentPatternFinder,
  CodeReader.ZXing.QrCode.Internal.Version,
  CodeReader.ZXing.DefaultGridSampler,
