...
unit CodeReader.ZXing.OneD.UPCEANExtension5Support;
...
//     Result := nil;
  ...
  dictionary1[CodeReader.ZXing.ResultMetadataType.SUGGESTED_PRICE] := TResultMetadata.CreateStringMetadata(value);
