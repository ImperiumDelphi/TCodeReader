...
unit CodeReader.ZXing.QrCode.Internal.AlignmentPattern;
interface
uses CodeReader.ZXing.ResultPoint;

type
  /// <summary>
  ///  As we did for ResultPoint, we use an interfaced object to implement automatic deallocation
  /// of TAligmnentPattern instances
  /// the actual implementation of this interface is in unit CodeReader.ZXing.QrCode.Internal.AlignmentPatternImplementation
  /// </summary>
...
implementation
uses CodeReader.ZXing.QrCode.Internal.AlignmentPatternImplementation;
...
begin
    result := CodeReader.ZXing.QrCode.Internal.AlignmentPatternImplementation.NewAlignmentPattern(posX,posY,estimatedModuleSize);
end;
