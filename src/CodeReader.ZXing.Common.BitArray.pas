...
unit CodeReader.ZXing.Common.BitArray;
...
implementation
uses CodeReader.ZXing.Common.BitArrayImplementation;

class function TBitArrayHelpers.CreateBitArray:IBitArray;
begin
  result := CodeReader.ZXing.Common.BitArrayImplementation.NewBitArray;
end;


class function TBitArrayHelpers.CreateBitArray(const Size: Integer):IBitArray;
begin
  result := CodeReader.ZXing.Common.BitArrayImplementation.NewBitArray(size);
end;
