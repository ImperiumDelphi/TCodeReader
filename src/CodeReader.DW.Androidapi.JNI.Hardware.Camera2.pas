unit CodeReader.DW.Androidapi.JNI.Hardware.Camera2;
...
type
  ...
  JCaptureRequestClass = interface(JCameraMetadataClass)
    ...
    {class} function _GetCONTROL_ENABLE_ZSL: JCaptureRequest_Key; cdecl;
    ...
    {class} property CONTROL_ENABLE_ZSL: JCaptureRequest_Key read _GetCONTROL_ENABLE_ZSL;
