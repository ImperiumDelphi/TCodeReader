...
unit CodeReader.ZXing.OneD.UPCEANExtension2Support;
...
begin
  ...
  dictionary1[CodeReader.ZXing.ResultMetadataType.ISSUE_NUMBER] := TResultMetaData.CreateStringMetadata(raw);
  Result := dictionary1;
end;
