...
unit CodeReader.ZXing.Datamatrix.Internal.Decoder;
...
uses
  ...
  CodeReader.ZXing.Datamatrix.Internal.BitMatrixParser,
  CodeReader.ZXing.Datamatrix.Internal.DataBlock,
  ...
  CodeReader.ZXing.Datamatrix.Internal.DecodedBitStreamParser;
