...
unit CodeReader.ZXing.OneD.Code128Reader;
...
type
  ...
  private const
    ...
    class function DecodeCode(row: IBitArray; counters: TArray<Integer>; rowOffset: Integer; var code: Integer): Boolean;

    class procedure DoInitialize();
    class procedure DoFinalize();
  public
    function decodeRow(const rowNumber: Integer; const row: IBitArray; const hints: TDictionary<TDecodeHintType, TObject>): TReadResult; override;
  end;
...
begin
  convertFNC1 := (hints <> nil) and
    (hints.ContainsKey(CodeReader.ZXing.DecodeHintType.ASSUME_GS1));
