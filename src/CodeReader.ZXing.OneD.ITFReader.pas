...
unit CodeReader.ZXing.OneD.ITFReader;
...
begin
  ...
  if ((hints <> nil) and hints.ContainsKey(CodeReader.ZXing.DecodeHintType.ALLOWED_LENGTHS)) then
  begin
    allowedLengths := TArray<Integer>(hints[CodeReader.ZXing.DecodeHintType.ALLOWED_LENGTHS]);
    maxAllowedLength := 0
  end;
