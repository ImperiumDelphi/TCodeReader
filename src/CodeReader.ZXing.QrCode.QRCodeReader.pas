...
unit CodeReader.ZXing.QrCode.QRCodeReader;
...
type
  ...
  private
    ...
    /// case.
    ///
    /// <seealso cref="CodeReader.ZXing.Datamatrix.DataMatrixReader.extractPureBits(TBitMatrix)" />
    /// </summary>
...
implementation
uses CodeReader.ZXIng.ByteSegments;
