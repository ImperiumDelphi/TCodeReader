...
unit CodeReader.ZXing.Datamatrix.DataMatrixReader;
...
uses
  ...
  CodeReader.ZXing.Datamatrix.Internal.Decoder,
  CodeReader.ZXing.Datamatrix.Internal.Detector;
...
type
  ...
  private
    ...
    /// case.
    ///
    /// <seealso cref="CodeReader.ZXing.QrCode.QRCodeReader.extractPureBits(TBitMatrix)" />
    /// </summary>
