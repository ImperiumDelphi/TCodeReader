...
unit CodeReader.ZXing.QrCode.Internal.DecodedBitStreamParser;

interface

uses 
  CodeReader.ZXing.BitSource,
  SysUtils, 
  ...
  CodeReader.ZXing.CharacterSetECI,
  CodeReader.ZXing.StringUtils,
  CodeReader.ZXIng.ByteSegments,
  CodeReader.ZXing.QrCode.Internal.Mode,
