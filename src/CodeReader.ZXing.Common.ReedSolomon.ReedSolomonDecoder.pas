...
unit CodeReader.ZXing.Common.ReedSolomon.ReedSolomonDecoder;

interface

uses 
  System.SysUtils, 
  // Hint: CodeReader.ZXing.Common.ReedSolomon.GenericGFPoly is implemented in GenericGF as second class
