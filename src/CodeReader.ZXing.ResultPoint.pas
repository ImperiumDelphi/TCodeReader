...
unit CodeReader.ZXing.ResultPoint;
...
type
  ...
  /// See CodeReader.ZXing.ResultPointImplementation to see the actual implementation of this interface.
...
implementation
uses CodeReader.ZXing.ResultPointImplementation;

class function TResultPointHelpers.CreateResultPoint:IResultPoint;
begin
   result := CodeReader.ZXing.ResultPointImplementation.NewResultPoint;
end;

class function TResultPointHelpers.CreateResultPoint(const pX, pY: Single):IResultPoint;
begin
   result := CodeReader.ZXing.ResultPointImplementation.NewResultPoint(px,py);
end;
