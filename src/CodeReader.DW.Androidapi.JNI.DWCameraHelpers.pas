unit CodeReader.DW.Androidapi.JNI.DWCameraHelpers;
...
uses
  ...
  // DW
  CodeReader.DW.Androidapi.JNI.Hardware.Camera2, CodeReader.DW.Androidapi.JNI.View;
...
type
  ...
  JDWCaptureRequestBuilderHelper = interface(JObject)
    ...
    procedure setBooleanValue(key: JCaptureRequest_Key; value: Boolean); cdecl;
    procedure setFloatValue  (key: JCaptureRequest_Key; value: Single); cdecl;
  end;
