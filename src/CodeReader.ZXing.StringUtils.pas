unit CodeReader.ZXing.StringUtils;
...
uses SysUtils, Generics.Collections, CodeReader.ZXing.DecodeHintType;
...
begin
  if ((hints <> nil) and hints.ContainsKey(CodeReader.ZXing.DecodeHintType.CHARACTER_SET)) then
  begin
    characterSet := string(hints[CodeReader.ZXing.DecodeHintType.CHARACTER_SET]);
