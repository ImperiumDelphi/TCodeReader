...
unit CodeReader.ZXing.QrCode.Internal.FinderPattern;
...
type
  ...
  /// the actual implementation of this interface is in unit CodeReader.ZXing.QrCode.Internal.FinderPatternImplementation
  /// </summary>
...
implementation
uses CodeReader.ZXing.QrCode.Internal.FinderPatternImplementation;
...
begin
   result :=  CodeReader.ZXing.QrCode.Internal.FinderPatternImplementation.NewFinderPattern(posX, posY, estimatedModuleSize ,count);
end;

class function TFinderPatternHelpers.CreateFinderPattern(const posX, posY, estimatedModuleSize: Single):IFinderPattern;
begin
   result :=  CodeReader.ZXing.QrCode.Internal.FinderPatternImplementation.NewFinderPattern(posX, posY, estimatedModuleSize);
end;
