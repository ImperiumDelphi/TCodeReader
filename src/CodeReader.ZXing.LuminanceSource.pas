...
unit CodeReader.ZXing.LuminanceSource;
...
type
  ...
  public
	...
	function getRow(const y: Integer; row: TArray<byte>): TArray<byte>; virtual; abstract;
	...
	function crop(const left, top, width, height: Integer): TLuminanceSource; virtual;
...
function TLuminanceSource.Crop(const left, top, width, height: Integer): TLuminanceSource;
begin
raise ENotImplemented.Create('This luminance source does not support cropping.');
end;
